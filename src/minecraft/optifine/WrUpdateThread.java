...
public class WrUpdateThread extends Thread
{
    ...
    public void run()
    {
        ...
        WrUpdateThread.ThreadUpdateListener updateListener = new WrUpdateThread.ThreadUpdateListener((WrUpdateThread.NamelessClass1832134939)null);
    ...
    static class NamelessClass1832134939
    {
    }
    ...
    private class ThreadUpdateControl implements IWrUpdateControl
    {
        ...
        ThreadUpdateControl(WrUpdateThread.NamelessClass1832134939 x1)
        {
            this();
        }
    }
    ...
    private class ThreadUpdateListener implements IWrUpdateListener
    {
        ...
        {
            this.tuc = WrUpdateThread.this.new ThreadUpdateControl((WrUpdateThread.NamelessClass1832134939)null);
        }
        ...
        ThreadUpdateListener(WrUpdateThread.NamelessClass1832134939 x1)
        {
            this();
        }
    }
