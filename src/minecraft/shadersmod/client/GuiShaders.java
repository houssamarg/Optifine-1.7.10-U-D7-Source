...
public class GuiShaders extends GuiScreen
{
    ...
    protected void actionPerformed(GuiButton button)
    {
        if (button.enabled)
        {
            if (button instanceof GuiButtonEnumShaderOption)
            {
                ...
                switch (GuiShaders.NamelessClass774492324.$SwitchMap$shadersmod$client$EnumShaderOption[var11.getEnumShaderOption().ordinal()])
                {
                    case 1:
    ...
    static class NamelessClass774492324
    {
